...
<head>
  ...
  <style>
    ...
    .city-card {
        ...
        margin-bottom: 15px !important; /* Spacing between cards */
    }
    ...
    .row {
        flex-direction: column !important; /* Stack the city cards vertically */
    }
}
...
@media (max-width: 600px) {
    ...
    .city-card {
        width: 100% !important; /* Ensure full width for very small screens */
        height: auto !important; /* Adjust height as needed */
    }
    ...
    .row {
        ...
        gap: 15px !important; /* Space between stacked cards */
