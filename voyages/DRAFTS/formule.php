...
<body>
    <div class="container">
        ...
        <!-- <div class="modal fade show" id="exampleModalToggle2" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2"
                tabindex="-1" >
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content show" style="display: block; position: fixed;">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="exampleModalToggleLabel2">Autres dates</h1>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body row text-center show" >
        ...
        <div  style="background-color:#f3f3f3;">
            <div class="row" style="gap:0px; margin-left:0px; margin-right:0px;">
                <!-- Table on the left -->
                <div class="col-md-6 grid" style="border: 1px solid black;">
                    <div class="table-responsive" style="padding:10px;">
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    <td>Individuelle</td>
                                    <td class="text-end"><?php echo htmlspecialchars($formule['prix_chambre_single']); ?> &euro;</td>
                                </tr>
                                <tr>
                                    <td>Double</td>
                                    <td class="text-end"><?php echo htmlspecialchars($formule['prix_chambre_double']); ?> &euro;</td>
                                </tr>
                                <tr>
                                    <td>Triple</td>
                                    <td class="text-end"><?php echo htmlspecialchars($formule['prix_chambre_triple']); ?> &euro;</td>
                                </tr>
                                <tr>
                                    <td>Quadriple</td>
                                    <td class="text-end"><?php echo htmlspecialchars($formule['prix_chambre_quadruple']); ?> &euro;</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <!-- <div class="col-md-6" style="border: 1px solid red";>
                    <div class="modal fade show" id="stepperModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                        aria-hidden="true" style="display: block; position: relative;">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="stepwizard">
                    <div class="stepwizard-row setup-panel">
                        <div class="stepwizard-step">
                            <a href="#step-1" type="button" class="btn btn-primary btn-circle non-clickable">1</a>
                            <p>Étape 1</p>
                        </div>
                        <div class="stepwizard-step">
                            <a href="#step-2" type="button" class="btn btn-default btn-circle non-clickable"
...
$prix_quadruple = isset($formule['prix_chambre_quadruple']) ? $formule['prix_chambre_quadruple'] : 0;
$prix_triple = isset($formule['prix_chambre_triple']) ? $formule['prix_chambre_triple'] : 0;
$prix_double = isset($formule['prix_chambre_double']) ? $formule['prix_chambre_double'] : 0;
$prix_single = isset($formule['prix_chambre_single']) ? $formule['prix_chambre_single'] : 0;
$prix_quadruple_promo = isset($formule['prix_chambre_quadruple_promo']) ? $formule['prix_chambre_quadruple_promo'] : 0;
$prix_triple_promo = isset($formule['prix_chambre_triple_promo']) ? $formule['prix_chambre_triple_promo'] : 0;
$prix_double_promo = isset($formule['prix_chambre_double_promo']) ? $formule['prix_chambre_double_promo'] : 0;
$prix_single_promo = isset($formule['prix_chambre_single_promo']) ? $formule['prix_chambre_single_promo'] : 0;
$prix_bebe = isset($formule['prix_bebe']) ? $formule['prix_bebe'] : 0;
$child_discount = isset($formule['child_discount']) ? $formule['child_discount'] : 0;
