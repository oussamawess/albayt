            ...
            <div class="accordion-item">
                ...
                <div id="flush-collapsezero" class="accordion-collapse collapse" aria-labelledby="flush-headingzero"
                    ...
                    <div class="accordion-body">
                        <div id="outer-carousel" class="owl-carousel owl-theme">
                            <div class="item">
                                <h4>Parent Slide 1</h4>
                                <!-- Inner Carousel -->
                                <div class="inner-carousel owl-carousel owl-theme">
                                    <div class="item">Nested Sub-slide 1</div>
                                    <div class="item">Nested Sub-slide 2</div>
                                    <div class="item">Nested Sub-slide 3</div>
                                </div>
                            </div>
                            <div class="item">
                                <h4>Parent Slide 2</h4>
                                <!-- Inner Carousel -->
                                <div class="inner-carousel owl-carousel owl-theme">
                                    <div class="item">Nested Sub-slide 1</div>
                                    <div class="item">Nested Sub-slide 2</div>
                        ...
                        <div id="hebergementsCarousel" class="carousel slide" data-bs-ride="carousel"
                                        ...
                                        <div class="carousel-item <?php echo $active ? 'active' : ''; ?>">
                                            <div class="card-container">
                                                <div class="hotel-image">
                                                    <div id="carousel<?php echo $hotel['hotel_id']; ?>" class="carousel slide"
                                                ...
                                                <div class="hotel-footer">
                                                    <div class="hotel-checkin hotel_info">
                                                        <svg class="hotel-icons" xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    <div class="hotel-nights hotel_info">
                                                        <svg class="hotel-icons" xmlns="http://www.w3.org/2000/svg"
                                                            width="67.255" height="67.255" viewBox="0 0 67.255 67.255">
                                                            <!-- SVG content -->
                                                        </svg>
                        ...
                        <a class="carousel-control-prev" href="#hebergementsCarousel" role="button"
                            data-bs-slide="prev">
                            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                            <span class="visually-hidden">Previous</span>
                        </a>
                        <a class="carousel-control-next" href="#hebergementsCarousel" role="button"
                            data-bs-slide="next">
                            ...
                            ?>
                                    <div class="card-container">
                                        ...
                                        <div class="hotel-info">
                                            ...
                                            <div class="hotel-details"><?php echo $hoteluni['ville']; ?></div>
                                            <div class="hotel-name">
                                                <h3 style="font-family: Bely Display;"><b><?php echo $hoteluni['nom']; ?></b>
                                                </h3>
                                            </div>
                                            <div class="hotel-stars">
                                                <?php
                                        ...
                                        <div class="hotel-footer">
                                            ...
                                            <div class="hotel-nights hotel_info">
                                                <svg class="hotel-icons" xmlns="http://www.w3.org/2000/svg" width="67.255"
                                                    height="67.255" viewBox="0 0 67.255 67.255">
        ...
        ?>
                ...
                <div style="background-color:white;">
                    <div class="row" style="gap:0px; margin-left:0px; margin-right:0px;">
                        <!-- Table on the left -->
                        <div class="col-md-4 grid" style="padding-right: 5px !important; padding-left: 5px !important; margin-bottom: 15px;">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>Individuelle</td>
                                            <td class="text-end">
                                                <?php echo htmlspecialchars($formule['prix_chambre_single']); ?> &euro;
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Double</td>
                                            <td class="text-end">
                                                <?php echo htmlspecialchars($formule['prix_chambre_double']); ?> &euro;
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Triple</td>
                                            <td class="text-end">
                                                <?php echo htmlspecialchars($formule['prix_chambre_triple']); ?> &euro;
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Quadriple</td>
                                            <td class="text-end">
                                                <?php echo htmlspecialchars($formule['prix_chambre_quadruple']); ?> &euro;
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                        ...
                        <div id="booking" class="col-md-8" style="padding-right: 5px !important; padding-left: 5px !important;">
                            ...
                            <div class="fade show" id="stepperModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                                aria-hidden="true" style="display: block; position: relative;">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header" style="justify-content: center;">
                                            <h4 class="modal-title" id="exampleModalLabel" style="margin-top: 10px; color:#028ae1">Réservez Votre Omra</h4>
