                                                            ...
                                                            while ($image = $gallery_result->fetch_assoc()) { ?>
                                                                <div class="tab-pane <?php echo $tabIndex === 0 ? 'active' : ''; ?>"
                                                                    ...
                                                                    <div class="d-block w-100"
                                                                        style="background-image: url('../<?php echo $image['image_path']; ?>'); height: 400px; background-size: cover; background-position: center; padding: 15px;">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                ...
                                                <?php if (!empty($formule_data['prix_chambre_single_promo']) && $formule_data['prix_chambre_single_promo'] != "0.00" && $formule_data['prix_chambre_single_promo'] != $formule_data['prix_chambre_single']): ?>
                                                    <br style="display: block;"><span style="color: red; font-weight: bold;">Promo</span>
                                                <?php endif; ?>
                                            </td>
                                            <td class="text-end">
                                                <?php if (!empty($formule_data['prix_chambre_single_promo']) && $formule_data['prix_chambre_single_promo'] != "0.00" && $formule_data['prix_chambre_single_promo'] != $formule_data['prix_chambre_single']): ?>
                                                    <span style="font-size: 1.2em; font-weight: bold;"><?php echo htmlspecialchars($formule_data['prix_chambre_single_promo']); ?> &euro;</span> <br style="display: block;">
                                                    <span style="text-decoration: line-through; color:red;"><?php echo htmlspecialchars($formule_data['prix_chambre_single']); ?> &euro;</span>
                                                <?php else: ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <?php if (!empty($formule_data['prix_chambre_double_promo']) && $formule_data['prix_chambre_double_promo'] != "0.00" && $formule_data['prix_chambre_double_promo'] != $formule_data['prix_chambre_double']): ?>
                                                    <span style="font-size: 1.2em; font-weight: bold;"><?php echo htmlspecialchars($formule_data['prix_chambre_double_promo']); ?> &euro;</span> <br style="display: block;">
                                                    <span style="text-decoration: line-through; color:red;"><?php echo htmlspecialchars($formule_data['prix_chambre_double']); ?> &euro;</span>
                                                <?php else: ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <?php if (!empty($formule_data['prix_chambre_triple_promo']) && $formule_data['prix_chambre_triple_promo'] != "0.00" && $formule_data['prix_chambre_triple_promo'] != $formule_data['prix_chambre_triple']): ?>
                                                    <span style="font-size: 1.2em; font-weight: bold;"><?php echo htmlspecialchars($formule_data['prix_chambre_triple_promo']); ?> &euro;</span> <br style="display: block;">
                                                    <span style="text-decoration: line-through; color:red;"><?php echo htmlspecialchars($formule_data['prix_chambre_triple']); ?> &euro;</span>
                                                <?php else: ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <?php if (!empty($formule_data['prix_chambre_quadruple_promo']) && $formule_data['prix_chambre_quadruple_promo'] != "0.00" && $formule_data['prix_chambre_quadruple_promo'] != $formule_data['prix_chambre_quadruple']): ?>
                                                    <span style="font-size: 1.2em; font-weight: bold;"><?php echo htmlspecialchars($formule_data['prix_chambre_quadruple_promo']); ?> &euro;</span> <br style="display: block;">
                                                    <span style="text-decoration: line-through; color:red;"><?php echo htmlspecialchars($formule_data['prix_chambre_quadruple']); ?> &euro;</span>
                                                <?php else: ?>
