...
<body>
    ...
    <script>
        $(document).ready(function() {
            ...
            $.ajax({
                url: 'formule/fetch_categories.php',
                method: 'GET',
            ...
            $('#ville').on('change', function() {
                ...
                $.ajax({
                    url: 'formule/fetch_formules.php',
                    method: 'GET',
                    data: {
                        ville_id: villeId
                    },
                    ...
                    success: function(data) {
                        try {
                            ...
                            dates.forEach((date) => {
                                ...
                                const cardHTML = `
                                    <a style="text-decoration: none; color: inherit;" target="_blank" href="formule/formule.php?id=${date.formule_id}">
