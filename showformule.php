...
<body>
    ...
    ?>
            ...
            <div class="container details-section" style="margin-top:2em">
                ...
                <ul class="nav nav-tabs justify-content-center" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="formule-tab" data-bs-toggle="tab" data-bs-target="#formule" type="button" role="tab" aria-controls="formule" aria-selected="true"><b>Pourquoi choisir la
                                <?php echo $nom_type_formule; ?></button> </b>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="hebergements-tab" data-bs-toggle="tab" data-bs-target="#hebergements" type="button" role="tab" aria-controls="hebergements" aria-selected="false"><b>Hébergements</b></button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="vols-tab" data-bs-toggle="tab" data-bs-target="#vols" type="button" role="tab" aria-controls="vols" aria-selected="false"><b>Vols CONFIRMÉ</b></button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="programme-tab" data-bs-toggle="tab" data-bs-target="#programme" type="button" role="tab" aria-controls="programme" aria-selected="false"><b>Programme du
                                séjour</b></button>
                    </li>
                </ul>
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade" id="hebergements" role="tabpanel" aria-labelledby="hebergements-tab">
                        <div class="row">
                            ...
                            <!-- start the one that i need carousel for -->
        ...
        <!-- end the one that i need carousel for -->
                ...
                <div class="row">
                            ...
                            <div class="card-body text-center">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="43" height="43" viewBox="0 0 43 43">
                                    <g id="icon-quadruple" transform="translate(-44 -17)">
                                        <circle id="Oval_Copy" data-name="Oval Copy" cx="21.5" cy="21.5" r="21.5" transform="translate(44 17)" fill="#f7f2e8"></circle>
                                        <g id="icon_triple" data-name="icon/triple" transform="translate(44.906 24)">
                                            <g id="Group_20" data-name="Group 20">
                                                <path id="Fill_1" data-name="Fill 1" d="M19.49,16.038H17.441a.4.4,0,0,1-.4-.4V14.059H2.843v1.583a.4.4,0,0,1-.4.4H.4a.4.4,0,0,1-.4-.4V10.1A1.987,1.987,0,0,1,1.591,8.162V1.393a.4.4,0,0,1,.3-.383A32.621,32.621,0,0,1,18,1.01a.4.4,0,0,1,.3.383V8.162a1.987,1.987,0,0,1,1.59,1.939v5.541A.4.4,0,0,1,19.49,16.038ZM2.445,13.267h15a.4.4,0,0,1,.4.4v1.583h1.252V11.684H.795v3.562H2.048V13.663A.4.4,0,0,1,2.445,13.267ZM1.988,8.913A1.192,1.192,0,0,0,.795,10.1v.792h18.3V10.1A1.192,1.192,0,0,0,17.9,8.913H1.988Zm10.835-.791H17.5V1.7a31.812,31.812,0,0,0-15.114,0v6.42H6.808V7.268A1.353,1.353,0,0,1,8.162,5.92h3.307a1.353,1.353,0,0,1,1.354,1.348ZM8.162,6.711a.559.559,0,0,0-.559.557v.853h4.424V7.268a.559.559,0,0,0-.559-.557Z" fill="#c7a150"></path>
                                                <path id="Fill_1_Copy" data-name="Fill 1 Copy" d="M19.49,16.038H17.441a.4.4,0,0,1-.4-.4V14.059H2.843v1.583a.4.4,0,0,1-.4.4H.4a.4.4,0,0,1-.4-.4V10.1A1.987,1.987,0,0,1,1.591,8.162V1.393a.4.4,0,0,1,.3-.383A32.621,32.621,0,0,1,18,1.01a.4.4,0,0,1,.3.383V8.162a1.987,1.987,0,0,1,1.59,1.939v5.541A.4.4,

                        ...
                        <div class="card">
                            ...
                            <div class="card-body text-center">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="43" height="43" viewBox="0 0 43 43">
                                    <g id="icon-triple" transform="translate(-44 -17)">
                                        ...
                                        <g id="icon_triple" data-name="icon/triple" transform="translate(45.377 26)">
                                            <path id="Fill_1" data-name="Fill 1" d="M19.489,16.038H17.441a.4.4,0,0,1-.4-.4V14.059H2.843v1.583a.4.4,0,0,1-.4.4H.4a.4.4,0,0,1-.4-.4V10.1A1.987,1.987,0,0,1,1.591,8.162V1.393a.4.4,0,0,1,.3-.383A32.62,32.62,0,0,1,18,1.01a.4.4,0,0,1,.3.383V8.162A1.989,1.989,0,0,1,19.887,10.1v5.541A.4.4,0,0,1,19.489,16.038ZM2.445,13.267h15a.4.4,0,0,1,.4.4v1.583h1.252V11.683H.8v3.562H2.047V13.663A.4.4,0,0,1,2.445,13.267ZM1.988,8.913A1.192,1.192,0,0,0,.8,10.1v.792h18.3V10.1A1.192,1.192,0,0,0,17.9,8.913H1.988Zm10.835-.791H17.5V1.7a31.827,31.827,0,0,0-15.114,0v6.42H6.808V7.268A1.353,1.353,0,0,1,8.162,5.92h3.307a1.353,1.353,0,0,1,1.354,1.349ZM8.162,6.711a.559.559,0,0,0-.559.557v.853h4.424V7.268a.558.558,0,0,0-.559-.557Z" transform="translate(0 0)" fill="#c7a150"></path>
                                            <path id="Fill_1_Copy" data-name="Fill 1 Copy" d="M19.489,16.038H17.441a.4.4,0,0,1-.4-.4V14.059H2.843v1.583a.4.4,0,0,1-.4.4H.4a.4.4,0,0,1-.4-.4V10.1A1.987,1.987,0,0,1,1.591,8.162V1.393a.4.4,0,0,1,.3-.383A32.62,32.62,0,0,1,18,1.01a.4.4,0,0,1,.3.383V8.162A1.989,1.989,0,0,1,19.887,10.1v5.541A.4.4,0,0,1,19.489,16.038ZM2.445,13.267h15a.4.4,0,0,1,.4.4v1.583h1.252V11.683H.8v3.562H2.047V13.663A.4.4,0,0,1,2.445,13.267ZM1.988,8.913A1.192,1.192,0,0,0,.8,10.1v.792h18.3V10.1A1.192,1.192,0,0,0,17.9,8.913H1.988Zm10.835-.791H17.5V1.7a31.827,31.827,0,0,0-15.114,0v6.42H6.808V7.268A1.353,1.353,0,0,1,8.162,5.92h3.307a1.353,1.353,0,0,1,1.354,1.349ZM8.162,6.711a.559.559,0,0,0-.559.557v.853h4.424V7.268a.558.558,0,0,0-.559-.557Z" transform="translate(21.17 0)" fill="#c7a150"></path>
                                            <path id="Fill_1_Copy_2" data-name="Fill 1 Copy 2" d="M19.489,16.038H17.441a.4.4,0,0,1-.4-.4V14.059H2.843v1.583a.4.4,0,0,1-.4.4H.4a.4.4,0,0,1-.4-.4V10.1A1.987,1.987,0,0,1,1.591,8.162V1.393a.4.4,0,0,1,.3-.383A32.62,32.62,0,0,1,18,1.01a.4.4,0,0,1,.3.383V8.162A1.989,1.989,0,0,1,19.887,10.1v5.541A.4.4,0,0,1,19.489,16.038ZM2.445,13.267h15a.4.4,0,0,1,.4.4v1.583h1.252V11.683H.8v3.562H2.047V13.663A.4.4,0,0,1,2.445,13.267ZM1.988,8.913A1.192,1.192,0,0,0,.8,10.1v.792h18.3V10.1A1.192,1.192,0,0,0,17.9,8.913H1.988Zm10.835-.791H17.5V1.7a31.827,31.827,0,0,0-15.114,0v6.42H6.808V7.268A1.353,1.353,0,0,1,8.162,5.92h3.307a1.353,1.353,0,0,1,1.354,1.349ZM8.162,6.711a.559.559,0,0,0-.559.557v.853h4.424V7.268a.558.558,0,0,0-.559-.557Z" transform="translate(10.906 17.962)" fill="#c7a150"></path>
                                        </g>
                                    </g>
                                </svg>
                                <?php if (!empty($formule_data['prix_chambre_triple_promo']) && $formule_data['prix_chambre_triple_promo'] != "0.00" && $formule_data['prix_chambre_triple_promo'] != $formule_data['prix_chambre_triple']) : ?>
                                    ...
                                    <div class="price">
                                        <?php echo number_format($formule_data['prix_chambre_triple_promo'], 0, ',', ' '); ?>€ <span class="badge bg-danger">Promo</span>
                                    </div>
                                <?php else : ?>
                                    <div class="price">
                                        <?php echo number_format($formule_data['prix_chambre_triple'], 0, ',', ' '); ?>€
                        ...
                        <div class="card">
                            ...
                            <div class="card-body text-center">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="43" height="43" viewBox="0 0 43 43">
                                    <g id="icon-double" transform="translate(-44 -17)">
                                        ...
                                        <g id="icon_double" data-name="icon/double" transform="translate(50.801 35.909)">
                                            <path id="Fill_1" data-name="Fill 1" d="M29.023,24h-3.05a.593.593,0,0,1-.592-.592V21.038H4.233v2.369A.593.593,0,0,1,3.641,24H.592A.593.593,0,0,1,0,23.408V15.115a2.97,2.97,0,0,1,2.369-2.9V2.084a.593.593,0,0,1,.445-.574,48.365,48.365,0,0,1,23.986,0,.593.593,0,0,1,.445.574v10.13a2.971,2.971,0,0,1,2.369,2.9v8.292A.593.593,0,0,1,29.023,24ZM3.641,19.853H25.974a.593.593,0,0,1,.592.592v2.369H28.43V17.484H1.184v5.331H3.049V20.445A.593.593,0,0,1,3.641,19.853Zm-.681-6.515a1.779,1.779,0,0,0-1.777,1.777V16.3H28.43V15.115a1.779,1.779,0,0,0-1.777-1.777H2.961ZM17.935,8.859h4.923a2.02,2.02,0,0,1,2.018,2.018v1.277h1.186V2.546a47.162,47.162,0,0,0-22.507,0v9.607H4.74V10.876A2.02,2.02,0,0,1,6.757,8.859h4.923A2.02,2.02,0,0,1,13.7,10.876v1.277h2.218V10.876A2.02,2.02,0,0,1,17.935,8.859Zm0,1.184a.834.834,0,0,0-.833.833v1.277H23.69V10.876a.834.834,0,0,0-.833-.833Zm-11.177,0a.834.834,0,0,0-.833.833v1.277h6.589V10.876a.834.834,0,0,0-.833-.833Z" transform="translate(0 0)" fill="#c7a150"></path>
                                        </g>
                                    </g>
                                </svg>
                                <?php if (!empty($formule_data['prix_chambre_double_promo']) && $formule_data['prix_chambre_double_promo'] != "0.00" && $formule_data['prix_chambre_double_promo'] != $formule_data['prix_chambre_double']) : ?>
                                    ...
                                    <div class="price">
                                        <?php echo number_format($formule_data['prix_chambre_double_promo'], 0, ',', ' '); ?>€ <span class="badge bg-danger">Promo</span>
                                    </div>
                                <?php else : ?>
                                    <div class="price">
                                        <?php echo number_format($formule_data['prix_chambre_double'], 0, ',', ' '); ?>€
                            ...
                            <div class="card-body text-center">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="43" height="43" viewBox="0 0 43 43">
                                    <g id="icon-simple" transform="translate(-44 -17)">
                                        <circle id="Oval_Copy" data-name="Oval Copy" cx="21.5" cy="21.5" r="21.5" transform="translate(44 17)" fill="#f7f2e8"></circle>
                                        <path id="Fill_1" data-name="Fill 1" d="M30.38,25H27.188a.619.619,0,0,1-.62-.616V21.915H4.432v2.468a.619.619,0,0,1-.62.616H.62A.619.619,0,0,1,0,24.383V15.745a3.1,3.1,0,0,1,2.48-3.022V2.171a.617.617,0,0,1,.466-.6,50.849,50.849,0,0,1,25.108,0,.617.617,0,0,1,.466.6V12.722A3.1,3.1,0,0,1,31,15.746v8.637A.619.619,0,0,1,30.38,25ZM3.812,20.68H27.189a.619.619,0,0,1,.619.617v2.468H29.76V18.212H1.239v5.553H3.191V21.3A.619.619,0,0,1,3.812,20.68ZM3.1,13.893a1.858,1.858,0,0,0-1.86,1.851v1.234H29.76V15.745a1.858,1.858,0,0,0-1.86-1.851H3.1ZM19.989,12.66H27.28V2.652a49.612,49.612,0,0,0-23.56,0V12.66h6.892V11.33a2.109,2.109,0,0,1,2.111-2.1h5.154a2.109,2.109,0,0,1,2.111,2.1Zm-7.266-2.2a.871.871,0,0,0-.871.868v1.33h6.9V11.33a.87.87,0,0,0-.871-.868Z" transform="translate(49 34)" fill="#c7a150"></path>
                                    </g>
                                </svg>
                    ...
                    <div class="col-md-3">
                        <div class="card">
                            ...
                            <div class="card-body text-center">
                                <h6><B>Bébé</B></h6>
                                <svg xmlns="http://www.w3.org/2000/svg" width="43" height="43" xmlns:xlink="http://www.w3.org/1999/xlink" id="Calque_1" x="0px" y="0px" viewBox="0 0 111.6 111.5" style="enable-background:new 0 0 111.6 111.5;" xml:space="preserve">
                                    <style type="text/css">
                                        .st0 {
                                            fill: #F7F2E8;
                                        }
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body row text-center">
                                ...
                                ?>
                                            <a href="showformule.php?formule_id=<?php echo $row['id']; ?>" class="col-md-12 justify-content-center text-decoration-none formule-item" style="color:inherit;">
                                ...
                                <form role="form">
                                    ...
                                    <div class="setup-content" id="step-2" style="display: none;">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control room-input" id="quadruple" min="0" required>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="setup-content" id="step-3" style="display: none;">
                                        ...
                                        <?php foreach ($extras as $extra) { ?>
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control extra-input" data-price="<?php echo $extra['prix']; ?>" min="0">
                                            </div>
                                        <?php } ?>
                                        <button class="btn btn-secondary prevBtn" type="button">Précedent</button>
